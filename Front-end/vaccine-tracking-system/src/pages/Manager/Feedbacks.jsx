  ...
  const SkeletonLoader = () => (
    <div className="space-y-4">
      {[1, 2, 3, 4].map((i) => (
        <div
          key={i}
          className="p-4 border rounded-lg shadow-sm animate-pulse h-20"
        >
  ...
  const renderFeedbackCard = (fb) => (
    ...
    >
      <div className="flex-1">
        <span className="px-2 py-1 bg-gray-100 rounded-full text-xs font-medium text-gray-600 mb-2 inline-block">
          ID: {fb.id}
        </span>
        ...
        <p className="text-sm text-gray-600">
          <span className="font-medium">Booking:</span> {fb.booking.bookingId}
        </p>
      </div>
