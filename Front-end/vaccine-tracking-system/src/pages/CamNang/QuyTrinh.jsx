        ...
        <div className="handbook-hero">
          ...
          <div className="hero-content">
            ...
            <p className="hero-subtitle">
              Khám phá hành trình tiêm chủng an toàn và hiệu quả với từng bước
              chi tiết.
            </p>
          </div>
        ...
        <div className="handbook-main">
          ...
          <section className="intro-section">
            ...
            <div className="intro-quote">
              ...
              <p>
                Tiêm chủng không chỉ là một mũi tiêm – đó là hành trình bảo vệ
                sức khỏe bạn và cộng đồng. Hiểu rõ quy trình giúp bạn chuẩn bị
                tốt hơn, giảm thiểu lo lắng và đảm bảo an toàn tối đa.
              </p>
            ...
            <div className="process-timeline">
              ...
              <div className="timeline-steps">
                <div className="timeline-step">
                  ...
                  <p>
                    Truy cập website hoặc ứng dụng để đặt lịch. Chọn vaccine,
                    ngày giờ, nhận mã QR qua email/SMS trong 2-3 phút.
                  </p>
                </div>
                ...
                <div className="timeline-step">
                  ...
                  <p>
                    Mang CMND/CCCD, mã QR, hồ sơ y tế (nếu có). Đeo khẩu trang,
                    ăn nhẹ, tuân thủ 5K.
                  </p>
                </div>
                ...
                <div className="timeline-step">
                  ...
                  <h3>Khám sàng lọc</h3>
                  <p>
                    Bác sĩ kiểm tra nhiệt độ, huyết áp, tiền sử bệnh lý. Thời
                    gian 5-10 phút để xác định điều kiện tiêm.
                  </p>
                </div>
                ...
                <div className="timeline-step">
                  ...
                  <h3>Tiêm vaccine</h3>
                  <p>
                    Nhân viên y tế thực hiện trong phòng vô trùng, nhanh chóng
                    và không đau.
                  </p>
                </div>
                ...
                <div className="timeline-step">
                  ...
                  <p>
                    Nghỉ ngơi 30 phút, nhận giấy chứng nhận và hướng dẫn chăm
                    sóc qua ứng dụng/giấy in.
                  </p>
                </div>
              </div>
            </div>
