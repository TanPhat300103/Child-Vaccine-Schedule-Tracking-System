    ...
    <header className="bg-primary p-4 sticky top-0 z-50 shadow-lg">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-4">
          ...
          <Link to="/register">
            <button className="px-6 py-2 bg-primary-foreground text-primary rounded-lg hover:bg-opacity-90 transition-all duration-300 font-semibold shadow-md hover:shadow-lg">
              Đăng Ký
            </button>
          </Link>
        </div>
