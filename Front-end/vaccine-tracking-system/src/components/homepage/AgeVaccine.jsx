                      ...
                      <div className="p-6 flex-1 flex flex-col">
                        ...
                        <div className="mt-4 pt-4 border-t border-gray-100">
                          ...
                          <div className="flex gap-2">
                            <button
                              onClick={() => handleAddRemoveCombo(combo)}
                              className={`flex-1 px-4 py-3 rounded-lg text-center font-medium transition-all ${
                                selectedVaccines.includes(combo.id)
                ...
                <div className="flex flex-col md:flex-row md:items-start gap-6">
                  ...
                  <div className="md:w-1/3">
                    <div className="bg-indigo-50 rounded-xl p-5 sticky top-6">
                      ...
                      <button
                        onClick={() => {
                          handleAddRemoveCombo(selectedCombo);
                          setOpenModal(false);
                        }}
                        className={`w-full px-4 py-3 rounded-lg text-center font-medium transition-all ${
                          selectedVaccines.includes(selectedCombo.id)
                            ? "bg-green-600 text-white shadow-md hover:bg-green-700"
                            : "bg-indigo-600 text-white shadow-md hover:bg-indigo-700"
                        }`}
                      >
                        {selectedVaccines.includes(selectedCombo.id) ? (
                          <>
                            <CheckCircle className="inline mr-2 h-4 w-4" /> Đã
                            thêm vào giỏ
                          </>
                        ) : (
                          "Thêm vào giỏ"
